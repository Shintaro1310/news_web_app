...
import { fetchScienceNewsList } from "@/network/science/client";

import { ScienceArticleNewsList, ScienceNewsList, ScienceSourceNewsList } from "@/network/science/model"; // Scienceの関連するモデルからのインポート
